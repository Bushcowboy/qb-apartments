...
-- RegisterServerEvent('apartments:rent', function(ap, amount)
--     local Player = QBCore.Functions.GetPlayer(source)
--     local cit = Player.PlayerData.citizenid
--     local name = ("%s %s"):format(Player.PlayerData.charinfo.firstname, Player.PlayerData.charinfo.lastname)
--     exports['Renewed-Banking']:handleTransaction(cit, "Personal Account /", amount, "Paid Rent For Apartment: "..ap, "Government",  name, "withdraw")
...
--         sender = "Government",
--         subject = "Apartment",
--         message = "You have paid rent for your apartment. <br/><br/>Apartment: "..ap..", Rent Amount: <strong>$"..amount.."</strong>",
--     })
-- end)
